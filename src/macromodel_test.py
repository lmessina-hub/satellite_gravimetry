...
simulation_end_epoch = DateTime(2019, 1, 1, 5, 0, 0).to_epoch() 
...
for satellite, seed in zip(["Grace-FO_A", "Grace-FO_B"], [42, 43]):
   ...
   # Generate pointing angles noise time series for each satellite
    ...
    error_free_pointing_angles_time_series[satellite], _ = NoiseGenerator.generate_pointing_angles_noise(
        plotter,
...
grace_fo_a_tle = dynamics.environment_setup.ephemeris.sgp4(
...
grace_fo_b_tle = dynamics.environment_setup.ephemeris.sgp4(
...
grace_fo_a_ephemeris = dynamics.environment_setup.create_body_ephemeris(grace_fo_a_tle, "GRACE-FO A")
grace_fo_b_ephemeris = dynamics.environment_setup.create_body_ephemeris(grace_fo_b_tle, "GRACE-FO B")

grace_fo_a_initial_state = grace_fo_a_ephemeris.cartesian_state(simulation_start_epoch)  # [m, m/s]
grace_fo_b_initial_state = grace_fo_b_ephemeris.cartesian_state(simulation_start_epoch)  # [m, m/s]
